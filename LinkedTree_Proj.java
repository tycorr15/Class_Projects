...
public class LinkedTree {
    ...
    /* depthiter simply take advantage of the fact that we have a BST
     * it checks the value of the root to find the key and tracks the depth simultaneously
     */
    ...
    /*
     * this is a simple recursive function.  again we simply check to see if the value is even. 
     * if it is we add 1 and continue recursion. if not simply continue recursion.
     */
   ...
   private static int numEvenKeysRec(Node root) {
	   ...
	   else if (root.key % 2 == 1) {
		   return 0 +(numEvenKeysRec(root.left) + numEvenKeysRec(root.right));
	   }
   ...
   /*
    * in this method I use 2 dummy nodes so that the parent node doesn't need to be maintained.
    * we know the max will be the deepest right child so we immediately move temp there while
    * have temp2 be that nodes parent then simply reassign temp2's child. 
    */
   public int deleteMax() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- Testing depthIter() from Problem 4 ---");
        System.out.println();
        System.out.println("(0) Testing on tree from Problem 3, depth of 48 node");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {44, 35, 53, 23, 48, 62, 28, 57, 80};
            tree.insertKeys(keys);
        ...
        System.out.println("--- Testing depthIter() from Problem 4 ---");
        System.out.println();
        System.out.println("(0) Testing on tree from Problem 3, depth of 38 node");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {44, 35, 53, 23, 48, 62, 28, 57, 80};
            tree.insertKeys(keys);
            
            int results = tree.depthIter(38);
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
        ...
        System.out.println("--- Testing numEvenKeys() from Problem 4 ---");
        System.out.println();
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {44, 35, 53, 23, 48, 62, 28, 57, 80};
        ...
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {43, 34, 53, 23, 41, 61, 28, 57, 84};
            tree.insertKeys(keys);
